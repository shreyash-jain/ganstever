...
export const img = {
  ...
  // named farm. These are generated for the Agulhas Wine Triangle post by
  ...
  // ---- AI-illustrative (road-trip journal post) ---------------------------
  // Same rules as the wine set above. Deliberately route and landscape scenes
  // only: no interiors and no named business, because an AI photograph of
  // "our table" or "the farm stall we always stop at" on a page written in the
  // family's own voice would be a lie. The house shots in this post are the
  // owner's real photographs.
  roadTripCover: {
    src: cldImage("road-trip-cover", "f_auto,q_auto,c_limit,w_2000"),
    alt: "An empty tar road curving south through golden Overberg wheat country toward a distant strip of sea — illustrative of the drive from Cape Town to Cape Agulhas.",
    width: 1024,
    height: 640,
  },
  suiderstrandGravelRoad: {
    src: cldImage("suiderstrand-gravel-road"),
    alt: "A graded gravel road running through low limestone coastal fynbos to a flat grey-green sea — illustrative of the last few kilometres into Suiderstrand.",
    width: 1024,
    height: 682,
  },
  // Species deliberately unnamed in the alt text: the generated animal reads as
  // a leopard tortoise, while the Agulhas Plain's characteristic species is the
  // angulate tortoise. "A tortoise" is the honest caption.
  tortoiseGravelVerge: {
    src: cldImage("tortoise-gravel-verge"),
    alt: "A tortoise crossing a pale gravel road between coastal fynbos — illustrative of why you take the last stretch into Suiderstrand slowly.",
    width: 1024,
    height: 682,
  },
  // Spares — generated and uploaded, not currently placed in the post.
  elginOrchardsN2: {
    src: cldImage("elgin-orchards-n2"),
    alt: "Orchards and a farm dam in a green mountain valley — illustrative of the Elgin valley on the N2, the first stop out of Cape Town.",
    width: 1024,
    height: 682,
  },
  r316WheatCountry: {
    src: cldImage("r316-wheat-country"),
    alt: "A quiet rural road between harvested wheatlands under a big cloudy sky — illustrative of the R316 between Caledon and Napier.",
    width: 1024,
    height: 682,
  },

  // ---- AI-illustrative (whale-season journal post) -------------------------
  // Same rules as the wine set above: generated by
  // scripts/generate-images-gemini.py, uploaded by upload-to-cloudinary.py,
  // clearly illustrative — never presented as a photograph of a specific
  // sighting. public_ids must match the generator's filenames.
  whaleCoastCover: {
    src: cldImage("whale-coast-cover", "f_auto,q_auto,c_limit,w_2000"),
    alt: "A southern right whale blowing offshore beyond fynbos-covered dunes under a soft grey winter sky — illustrative of whale season along the Cape Agulhas coast.",
    width: 2000,
    height: 1250,
  },
  southernRightShore: {
    src: cldImage("southern-right-shore"),
    alt: "A southern right whale surfacing close to a pale, empty beach, its dark back and callosities clear above cold green water — illustrative of how near the whales come to shore at Struisbaai.",
    width: 1536,
    height: 1024,
  },
  stormSeaWinter: {
    src: cldImage("storm-sea-winter"),
    alt: "A winter cold front moving in over the sea beyond coastal fynbos, a curtain of rain offshore and low dramatic light — the storm-watching weather of a southern-tip July.",
    width: 1536,
    height: 1024,
  },
